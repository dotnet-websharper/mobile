...
/**
 * An simple 8-bit ExtendedAscii encoding. Every character corresponds to a byte.
...
final class ExtendedAsciiEncoding {
	 ...
	 * Converts a string to a byte array.
	 */
	final public static byte[] getBytes(final String text, final int offset, final int length) {
	 ...
	 * Converts a byte array to a string.
	 */
	final public static String getString(final byte[] data, final int offset, final int length) {
